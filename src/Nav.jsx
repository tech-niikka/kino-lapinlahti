...
const Nav = React.forwardRef(
  (
    ...
    return (
      <div className="bg-navorange flex items-center justify-between py-[1.5rem] px-[2rem] custom-710:px-[4rem]">
        <div>
          <img class="w-40 h-10 cursor-pointer custom-710:w-48 custom-710:h-12" src={logo} alt="image" />
        </div>
        ...
        <div className={
          ...
          <div >
           <ul className="flex flex-col flex-wrap gap-[1.5rem]">
             <li
              onClick={() => {handleScroll(ref[0]),setMenuOpen(false)}}
             ...
             <li
              onClick={() => {handleScroll(ref[1]),setMenuOpen(false)}}
              class="px-2 py-1 text-heading text-center uppercase border-2 border-solid rounded-full w-36  hover:bg-heading hover:text-navorange font-sans-700 cursor-pointer"
             >
              {catalogTitle}
             </li>
             <li
              onClick={() => {handleScroll(ref[2]),setMenuOpen(false)}}
              class="px-2 py-1 text-heading text-center uppercase border-2 border-solid rounded-full w-36  hover:bg-heading hover:text-navorange font-sans-700 cursor-pointer"
             >
              {eventTitle}
             </li>
             <li
              onClick={() => {handleScroll(ref[3]),setMenuOpen(false)}}
              class="px-2 py-1 text-heading text-center uppercase border-2 border-solid rounded-full w-36  hover:bg-heading hover:text-navorange font-sans-700 cursor-pointer"
             >
              {areaTitle}
             </li>
          ...
          <div class='flex flex-row justify-center items-center'>
            <AiOutlineInstagram size={30} class='cursor-pointer  text-heading'/>

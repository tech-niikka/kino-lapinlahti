  ...
  return (
    <div>
      ...
      <div class='flex mx-auto items-center justify-center p-[2rem] pt-[3rem] '>
        <a class='font-black underline text-center' target="_blank"   href="https://linktr.ee/lapinlahtifilmfestival"> Open call for submissions - 2025 film festival / Avoin ohjelmahaku - 2025 festareille</a>

        ...
        <div className="flex flex-col w-[100%] lg:pr-[5rem] lg:w-[50%]">
          <div className="w-[100%] mb:w-[88%]">
            ...
            <div className="flex flex-col justify-between item ">
             ...
             {/* This is a JSX comment  <h2 className="py-5 leading-7 font-bold">{data?.paragraph4} <a className='hover:underline' href="https://forms.gle/vH6HE7zVd7oM6b8K9">https://forms.gle/vH6HE7zVd7oM6b8K9</a></h2>
             */}
            </div>
          </div>
        </div>

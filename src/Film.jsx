    ...
    <div className="flex flex-col justify-center w-[95%] custom-440:w-[70%] text-sm relative px-0 custom-588:px-[1rem] py-[0.1rem] custom-588:py-[3rem] custom-590:flex-col custom-590:w-[50%] custom-1120:w-[50%] sm:w-[100%] sm:flex-row custom-1150:w-[50%]  ">
      ...
      <div className="flex flex-col justify-between h-full w-[100%] sm:w-[60%] custom-1150:w-[60%] custom-1120:w-[60%]">
        ...
        <div className='flex flex-col justify-between  custom-588:pt-0'>
          ...
          <div className="uppercase text-sm font-light">{film.fields.genre}</div>
          </div>
          ...
          <div className="text-sm pt-[0.1rem] pb-[0rem] font-light">{film.fields.length}</div>
          <div className='flex flex-row  '>
          <div className="text-sm pt-[0.1rem] pr-[0.5rem] font-semibold">{film.fields.languageTitle}</div>
          <div className="text-sm pt-[0.1rem]  font-light">{film.fields.filmlanguage}</div>
          </div>
          <div className='flex flex-row  '>
          <div className="text-sm pt-[0.1rem] pr-[0.5rem] font-semibold">{film.fields.textTitle}</div>
          <div className="text-sm pt-[0.1rem] pb-[1rem] font-light">{film.fields.textlanguage}</div>
          </div>
        ...
        <div className=" flex flex-row text-xs pt-[0.25rem] custom-588:pt-[1rem] pb-[2rem] custom-588:pb-[0.5rem]">{film.fields.productionCompany}  {film.fields.country}</div>
      </div>
    </div>
  );
};

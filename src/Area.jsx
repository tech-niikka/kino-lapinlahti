...
function Area() {
  return (
    <div class='w-screen mb-20'>
        <div class='max-w-[1270px] flex flex-row items-center justify-center mx-20'>
            <div class='flex flex-col w-2/3'>
               <div class=''>
                <h1 class='font-serif font-semibold text-4xl mb-4'>Miten saavut paikalle</h1>
            </div>
        <div class=' flex flex-col justify-between w-2/3'>
            <div class='py-4'>
              <h3 class='font-bold leading-7'>Sijainti</h3>
              <h2 class=''>Kino Lapinlahti järjestetään Lapinlahden puistoalueella Hietaniemen hautausmaan vieressä.</h2>
            </div>
             ...
             <div class='py-4'>
               ...
               <h2 class=''>Tapahtuma on ikäräjaton. Joidenkin elokuvien ikäraja on k16.</h2>
             </div>
             <div class='py-4'>
               <h3 class='font-bold leading-7'>Esteettömyys</h3>
               <h2 class=''>Kaikkiin muihin rakennuksiin, paisi ... on esteetön kulku</h2>
             </div>
        </div>
        </div>

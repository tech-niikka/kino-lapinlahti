...
export const buildCatalog = (locale) => {
  ...
  const films = [
    film({
      ...
      age: t("12 (seksuaaliset viittaukset)", "12 (sexual references)", "12 (sexuella referenser)"),
    ...
    film({
      ...
      subs: t("suomi", "Finnish", "finska"),
      age: t("12 (seksi, lievä ahdistus)", "12 (sex, light anxiety)", "12 (sex, lätt ångest)"),
    ...
    film({
      ...
      age: t("12 (lievä ahdistus, viittaukset seksiin ja kuolemaan)", "12 (light anxiety, references to sex and death)", "12 (lätt ångest, referenser till sex och döden)"),
      director: "Aleksi Salmenperä",
      country: t("Suomi", "Finland"),
      year: "2015",
      desc: t(
    ...
    film({
      ...
      age: t("7 (lievä ahdistus)", "7 (light anxiety)", "7 (lätt ångest)"),
    ...
    film({
      ...
      age: t("16 (väkivalta, seksi, ahdistus)", "16 (violence, sex, anxiety)", "16 (våld, sex, ångest)"),
      director: "Rose Glass",
    ...
    film({
      ...
      subs: t("englanti", "English", "engelska"),
      age: t("16 (väkivalta, ahdistus)", "16 (violence, anxiety)", "16 (våld, ångest)"),
    ...
    film({
      ...
      subs: t("englanti", "English", "engelska"),
      age: t("12 (lievä ahdistus)", "12 (light anxiety)", "12 (lätt ångest)"),
    ...
    film({
      ...
      subs: t("englanti", "English", "engelska"),
      age: t("16 (seksi, väkivalta, ahdistus)", "16 (sex, violence, anxiety)", "16 (sex, våld, ångest)"),
    ...
    film({
      ...
      subs: t("englanti", "English", "engelska"),
      age: t("12 (päihteiden käyttö)", "12 (substance use)", "12 (rusmedelsbruk)"),
    ...
    film({
      ...
      subs: t("suomi, ruotsi", "Finnish, Swedish", "finska, svenska"),
      age: t("12 (seksuaaliset viittaukset, lievä ahdistus)", "12 (sexual references, light anxiety)", "12 (sexuella referenser, lätt ångest)"),
      director: "Levan Akin",
    ...
    film({
      ...
      lang: t("englanti", "English", "engelska"),
      subs: t("suomi, ruotsi", "Finnish, Swedish", "finska, svenska"),
      age: t("7 (lievä ahdistus, viittaukset kuolemaan)", "7 (light anxiety, references to death)", "7 (lätt ångest, referenser till döden)"),
